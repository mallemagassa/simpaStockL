...
use App\Filament\Clusters\StockOut\Resources\OutResource\Pages;
use App\Filament\Clusters\StockOut\Resources\OutResource\RelationManagers;
...
class OutResource extends Resource
{
    ...
    protected static ?string $label = 'Sortie';
    ...
    public static function form(Form $form): Form
    {
        return $form
                ...
                ->schema(components: [
                   TextInput::make('ref')
                    ...
                    ->default(function () {
                        ...
                        if ($out && substr($out->ref, 2, 8) === $today) {
                            $lastNumber = (int) substr($out->ref, 10);
                        } else {
                            $lastNumber = 0;
                        }
                
                        $newNumber = str_pad($lastNumber + 1, 5, '0', STR_PAD_LEFT);
                        return "BS{$today}{$newNumber}";
                    })
                    ->disabled()
                    ->dehydrated(),
            ...
            Section::make("Articles")
                ...
                ->columnSpan(6)
                ->collapsible(),
                // ->mutateRelationshipDataBeforeFillUsing(function (Model $record,array $data): array {
                //     //dd($data, $record->outItems);
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => Pages\ViewOut::route('/{record}'),
