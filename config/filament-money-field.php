...
return [
    ...
    |
    */
    'default_locale' => env('MONEY_DEFAULT_LOCALE', 'fr_FR'),
    ...
    |
    */
    'default_currency' => env('MONEY_DEFAULT_CURRENCY', 'XOF'),
    ...
    */
    ...
    |
    */
    'form_currency_symbol_placement' => env('MONEY_UNIT_PLACEMENT', 'hidden'),
